        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="photos/fruits-legumes/carotte.jpg" alt="Photo de crème de petits" alt="First slide">
                </div>
...
<section class="margin-section container">
    <div class="row justify-content-between">
        <div class="card" style="width: 18rem;">
            <img src="photos/recettes/risotto-feves-asperges.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="photos/recettes/carottes-glacees-orange.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Voir recette</a>
        ...
        <div class="card" style="width: 18rem;">
            <img src="photos/recettes/creme-petits-poids.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Voir recette</a>
